...
def user_data(request):
    ...
    if request.method == 'POST':
        ...
        if parent_name and student_name and relationship_id:
            ...
            return render(request, 'appointments_bl/user_data.html', {
...
def motivo(request):
    ...
    return render(request, 'appointments_bl/motivo.html', {
...
def select_date(request, appointment_id):
    ...
    return render(request, 'appointments_bl/select-date.html', {
        'appointment': appointment,
    })
...
def dashboard(request):
    ...
    return render(request, 'appointments_bl/dashboard.html', {
